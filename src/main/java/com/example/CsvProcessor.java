...
public class CsvProcessor {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the path to the input CSV file: ");
        ...
        if (!inputFile.exists() || inputFile.isDirectory()) {
            System.err.println("Error: The input file '" + inputFilePath + "' does not exist or is a directory.");
            System.exit(1);
        }

        // Prompt the user for the output Excel file path
        System.out.print("Enter the path to save the output Excel file: ");
