...
//                        }
//
//                        // Check if this is the meta product
//                        if (record.equals(metaRecord)) {
//                            // Meta product must have a title and at least one option name
//                            if (title.isEmpty()) {
//                                errors.get("Other Errors").add(new ProductError("Meta product must have a title", record));
//                                isValid = false;
//                            }
//                            if (metaOption1Name.isEmpty() && metaOption2Name.isEmpty()) {
//                                errors.get("Other Errors").add(new ProductError("Meta product must have at least one option name", record));
//                                isValid = false;
//                            }
//                        } else {
//                            // This is a variant
//                            // Variants cannot have a title
//                            if (!title.isEmpty()) {
//                                errors.get("Other Errors").add(new ProductError("Variants cannot have a title", record));
//                                isValid = false;
//                            }
//
//                            // Variants must inherit option names from the meta product
//                            if (!option1Name.isEmpty() && !option1Name.equalsIgnoreCase(metaOption1Name)) {
//                                errors.get("Invalid Options").add(new ProductError(
//                                        "Variant Option1 Name must match meta product: " + metaOption1Name, record));
//                                isValid = false;
//                            }
//                            if (!option2Name.isEmpty() && !option2Name.equalsIgnoreCase(metaOption2Name)) {
//                                errors.get("Invalid Options").add(new ProductError(
//                                        "Variant Option2 Name must match meta product: " + metaOption2Name, record));
//                                isValid = false;
//                            }
//
//                            // Variants must provide values for inherited option names
